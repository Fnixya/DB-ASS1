...
SELECT PHYSICAL_FEATURES FROM FASDB.ACERVUS FECTH TOP 10 ENTRIES ONLY;
...
SELECT TITLE, NATIONAL_LIB_ID, PUBLISHER, EDITION FROM FSDB.ACERVUS WHERE ISBN = '84-226-5246-3';